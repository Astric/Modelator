...
-(void)setHighlightLanguage:(NSString *)highlightLanguage {
    _highlightLanguage = highlightLanguage;
    [[self.webView windowScriptObject] callWebScriptMethod:@"setLang" withArguments:@[highlightLanguage]];
}
@end
